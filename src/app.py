...
activities = {
    ...
    "Swimming Team": {
        "description": "Swim practice and competitive meets for all skill levels",
    ...
    "Drama Club": {
        "description": "Acting, improvisation, and stage production for performances",
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["logan@mergington.edu", "eva@mergington.edu"]
    }
}
